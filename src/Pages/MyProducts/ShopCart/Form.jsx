...
<form
			...
			class="text-white text-center lg:text-base text-lg py-3 px-9  rounded-3xl  bg-black shadow-[0_20px_20px_0px_rgba(0,0,0,0.20)] max-[650px]:w-full">
					Оформить заказ
				</button>
				<button class="text-white text-center hidden  lg:text-base w-full text-lg py-1 px-9  rounded-3xl  bg-[#1CBBEE] shadow-[0_20px_20px_0px_rgba(0,0,0,0.20)] max-[650px]:block">
					<a
						href="https://t.me/vevauz_bot"
						target="_blank"
					...
					>
						...
						>
							<path
								d="M9.9174 13.1812L9.5204 18.7654C10.0884 18.7654 10.3344 18.5214 10.6294 18.2284L13.2925 15.6833L18.8106 19.7244C19.8226 20.2884 20.5357 19.9914 20.8087 18.7934L24.4308 1.82096L24.4318 1.81996C24.7528 0.323925 23.8907 -0.261089 22.9047 0.10592L1.6142 8.25711C0.16117 8.82113 0.18317 9.63115 1.3672 9.99816L6.81033 11.6912L19.4536 3.78001C20.0486 3.386 20.5897 3.604 20.1446 3.99801L9.9174 13.1812Z"
								fill="white"
							/>
						</svg>
						
						<a href="https:/web.tlgrm.app" class="text-sm">Заказать через <br />
							<span class="font-bold">телеграмм бот</span></a>
					</a>
				</button>
			</form>
			</div>

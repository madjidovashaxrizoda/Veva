...
const ShopProducts = () => {
	...
	return (
		<div class="w-10/12 m-auto ">
			{/* <Nav/> */}
			<div class="flex pt-[17%] gap-4 border-b-4 border-zinc-300 max-[650px]:hidden">
				<button
					onClick={() => {
						document
				...
				>
					...
					<p
						id="amountOfBottle"
						class="bg-[#E9573F] text-white text-center rounded-full px-2 py-1 font-bold text-[12px] "
					>
						0
					</p>
				</button>
				<button
					...
					class="flex gap-1 text-center items-center  focus:text-black focus:bg-[#F2F4F7] focus:rounded-t-lg px-4 py-3 "
				>
					<p class="text-[#98A2B3] text-sm font-semibold">Кулер</p>
					<p
						id="amountOfKuler"
						class="bg-[#E9573F] text-white text-center rounded-full px-2 py-1 font-bold text-[12px] "
					>
				...
				<button
					...
					class="flex gap-1 text-center items-center focus:text-black focus:bg-[#F2F4F7] focus:rounded-t-lg px-4 py-3"
				>
					<p class="text-[#98A2B3] text-sm font-semibold">Помпа</p>
					<p
						id="amountOfPompa"
						class="bg-[#E9573F] text-white text-center rounded-full px-2 py-1 font-bold text-[12px] "
					>
